### Run the code
For simulation data, make sure the dataset starts with a number, such as data_large2：\${id}_clone\${i}_error\${j}, which can be run quickly by number. For example, to run dataset 0 (0_clone6_error0.4) on the simulated data, use the following code:

```python
python train.py \
    --data_dir ../data/simulated_data/ \ # The path of simulation folder
...
```python
python train.py \
    --data_dir ../data/lineage_trace_data/ \ # The path of folder
