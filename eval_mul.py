...
if __name__ == "__main__":
    ...
    for sc in scorings.keys():
        ...
        for i in [1, 2, 5, 6, 7]:
            idx = f'data_{i}'
            res[idx] = []
            meta = pd.read_csv(f'/home/ubuntu/duxinghao/clone/data/CNV_multiSample_martix/data{i}_meta.csv', index_col=0)
            pred_label = pd.read_csv(f'/home/ubuntu/duxinghao/clone/rl_leiden/results/CNV_multiSample_martix/{method}/CNV/leiden/data{i}_CNV/cell2cluster.csv', index_col=0).values.reshape(-1)
        ...
        res.columns = cols
        res.to_csv(f'/home/ubuntu/duxinghao/clone/rl_leiden/results/CNV_multiSample_martix/{method}/CNV/leiden/column_{sc}.csv')
