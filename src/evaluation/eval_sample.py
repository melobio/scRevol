...
def process_dataset(task_type, data_name, method, data_type, meta_columns):
    ...
    meta_df_path = f'./clone/data/{task_type}/{data_name}_meta.csv'
    cell2cluster_path = f'./clone/rl_leiden/results/{task_type}/{method}/{data_type}/leiden/{data_name}_{type_prefix}/cell2cluster.csv'
    ...
    for meta_column in meta_columns:
        ...
        output_dir = f'./clone/rl_leiden/results/{task_type}/{method}/{data_type}/leiden/{data_name}_{type_prefix}'
...
if __name__ == '__main__':
    ...
    # Save results to CSV
    results_df = pd.DataFrame(all_results)
    output_csv_path = f'./clone/rl_leiden/results/{task_type}/{method}/{data_type}/leiden/summary_results.csv'
    ...
    summary_csv_path = f'./clone/rl_leiden/results/{task_type}/{method}/{data_type}/leiden/summary_statistics.csv'
