...
def calculate_summary_statistics(results_folder, num_files=500):
    ...
    for dir in os.listdir(results_folder):
        ...
        if os.path.exists(file_path):
            ...
            try:
                ...
                metrics = df.iloc[0][['nmi', 'ari', 'vm', 'lcc', 'pcd', 'tc']].to_dict()
    ...
    summary_df = metrics_df[['nmi', 'ari', 'vm', 'lcc', 'pcd', 'tc']].agg(['mean', 'var'])
...
if __name__ == '__main__':
    ...
    results_folder = f'./clone/rl_leiden/results/data_large2/{args.method}/{args.data_type}/leiden/'
